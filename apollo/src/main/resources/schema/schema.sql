...
--changeset chenbaining:1
create table if not exists admin_oplog
(
...
create unique index if not exists admin_oplog_id_uindex
    on admin_oplog (id);
...
create unique index if not exists admin_user_id_uindex
    on admin_user (id);
...
create unique index if not exists api_app_id_uindex
    on api_app (id);

create table if not exists api_apply
(
    id          varchar(10)                         not null
...
create unique index if not exists api_apply_id_uindex
    on api_apply (id);
...
create unique index if not exists payment_record_id_uindex
...
create unique index if not exists point_balance_id_uindex
    on point_balance (id);
...
create unique index if not exists point_record_tid_uindex
    on point_record (tid);

create unique index if not exists point_record_id_uindex
    on point_record (id);

create table if not exists point_sku
(
    id         varchar(10)                         not null
...
create unique index if not exists point_sku_id_uindex
    on point_sku (id);
...
create unique index if not exists user_extra_id_uindex
    on user_extra (id);
